...
public class Constants {
  public static final String APPID = "1105566727";
  public static final String BannerPosID = "4070013497608480";
  public static final String APPWallPosID = "2000816477488053";
